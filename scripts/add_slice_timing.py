...
def main():
    parser = argparse.ArgumentParser(description='Add SliceTiming to BIDS JSON files.')
    parser.add_argument('bids_dir', help='Path to BIDS root directory')
    parser.add_argument('--tr', type=float, default=2.2, help='Repetition Time (TR)')
    parser.add_argument('--nslices', type=int, default=40, help='Number of slices')
    parser.add_argument('--order', choices=['interleaved', 'ascending', 'descending'], 
                        default='ascending', help='Slice acquisition order')
